...
import {selectAddOption, selectDelete, selectUpdate} from "../store/form/form.actions";
...
export class SelectItemComponent extends FormItemStyle implements OnInit, OnDestroy {
  ...
  protected applyFieldStyles(): void {
    if(this.formControl.valid) {
      ...
      this.store$.dispatch(selectUpdate({
        ...
        selectCheckRequired: !!this.formControl.get('selectCheckRequired')?.value!,
