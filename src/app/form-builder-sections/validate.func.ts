...
export function ValidatePxWidth(control: AbstractControl): {[key: string]: any} | null  {
...
export function ValidatePxHeight(control: AbstractControl): {[key: string]: any} | null  {
  const value = parseInt(control.value.substring(0, control.value.length - 2));
  const pxValue = control.value.substring(control.value.length - 2, control.value.length);
...
export function ValidatePxFont(control: AbstractControl): {[key: string]: any} | null  {
  const value = parseInt(control.value.substring(0, control.value.length - 2));
  const pxValue = control.value.substring(control.value.length - 2, control.value.length);
